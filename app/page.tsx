    ...
    <main>
      ...
      <header className="site-header">
        ...
        <nav className={menuOpen ? "main-nav main-nav--open" : "main-nav"}>
          <Link href="/#shop" onClick={() => setMenuOpen(false)}>Shop</Link><Link href="/#bestsellers" onClick={() => setMenuOpen(false)}>Bestsellers</Link><Link href="/#story" onClick={() => setMenuOpen(false)}>Our story</Link><Link href="/#customisation" onClick={() => setMenuOpen(false)}>Make it yours</Link>
        </nav>
